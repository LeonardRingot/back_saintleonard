...
describe('BadgeService', () => {
    ...
    describe('findAll', () => {
        it('should return an array of badge', async () => {
            ...
            jest.spyOn(badgeRepository, 'findAll').mockResolvedValue(expectedbadge);
    ...
    describe('findById', () => {
        it('should return a badge by its id', async () => {
          const id = 1;
          const expectedbadge: BadgeDto = { id_badge: id, name: 'badge 1', image:"a.jpg" };
          jest.spyOn(badgeRepository, 'findById').mockResolvedValue(expectedbadge);
    ...
    describe('create', () => {
        it('should create a new badge', async () => {
          ...
          jest.spyOn(badgeRepository, 'create').mockResolvedValue(createdBadge);
